...
def print_versions():
    ...
    import sys, platform
    print("-=" * 38)
    print("neat version: %s" % __version__)
    print("kdbpy version: %s" % kdbpy.__version__)
    print("qpython version: %s" % qpython.__version__)
