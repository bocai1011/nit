        ...
        return (
            <div>
                ...
                <div className="content">
                    <h1 className="content-subhead">Dashboard</h1>
                    <p>
                    ...
                    <h1 className="content-subhead">Staging</h1>
                    <p>
                        Blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah.
                    </p>
                    ...
                    <h1 className="content-subhead">Uploading</h1>
                    <p>
                        Blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah.
                    </p>

                    <h1 className="content-subhead">Power Tools</h1>
                    <p>
                        Blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah.
                    </p>
                </div>
