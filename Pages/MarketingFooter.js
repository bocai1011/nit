...
export default React.createClass({
    ...
    render: function() {
        return (
            <div className="row">
                <div className="content" id="about-neat">
                    <h2 className="is-center">The National Exam Analytics Tool</h2>
                    ...
                    <div className="">
                        <div className="">
                            ...
                            <p>
                                NEAT3 is an enterprise class platform for exam analyses. Built by the SECs in-house QAU development team and leveraging a leading edge technology stack, NEAT3 brings high powered 21st century technology to your hands. Analyse billions of data points with ease. NEAT3 ushers in the era of big data for market regulation.
                            </p>
                        </div>
